        ...
        if (typeof prependTextQueryCard === 'function') {
            ...
            resultsDiv.insertAdjacentHTML('afterbegin', `
                <div class="card text-query-card" style="background:white;border-radius:12px;padding:16px;margin-bottom:10px;">
                    <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;"><div style="font-size:18px;font-weight:bold;color:#1e293b;">${escapeHtml(query)}</div>${renderTextQueryFavoriteCard(query)}</div>
